...
public interface ClUtilsLibrary extends Library {
	 ...
	 * @deprecated use the safer methods {@link #clLogInitialize(java.nio.LongBuffer, clUtils.ClLogCallbacksT, com.sun.jna.Pointer)} and {@link #clLogInitialize(com.sun.jna.ptr.LongByReference, clUtils.ClLogCallbacksT, com.sun.jna.Pointer)} instead
	 */
	@Deprecated 
	 ...
	 */
	int clLogWriteAsyncWithContextHeader(long hStream, int severity, ByteBuffer pArea, ByteBuffer pContext, short serviceId, short msgId, Object... varArgs1);
	/**
	 * *********************************************************************<br>
	 ...
	 */
	int clLogFileOpen(long hLog, ByteBuffer fileName, ByteBuffer fileLocation, short isDelete, LongBuffer phFile);
	/**
	 * *********************************************************************<br>
	 ...
	 * @deprecated use the safer methods {@link #clLogFileMetaDataGet(long, clUtils.ClLogStreamAttributesT, java.nio.IntBuffer, clUtils.ClLogStreamMapT.ByReference[])} and {@link #clLogFileMetaDataGet(long, clUtils.ClLogStreamAttributesT, com.sun.jna.ptr.IntByReference, clUtils.ClLogStreamMapT.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 */
	int clLogFileMetaDataGet(long hFileHdlr, ClLogStreamAttributesT pStreamAttr, IntBuffer pNumStreams, clUtils.ClLogStreamMapT.ByReference ppLogStreams[]);
	/**
	 * *********************************************************************<br>
	 *  \brief Gets the metadata of the file. <br>
	 *  \par Header File:<br>
	 ...
	 * <i>native declaration : /home/clovis/opt/sdk-6.1/src/SAFplus/components/log/include/clLogApi.h:1542</i>
	 */
	int clLogFileMetaDataGet(long hFileHdlr, ClLogStreamAttributesT pStreamAttr, IntByReference pNumStreams, clUtils.ClLogStreamMapT.ByReference ppLogStreams[]);
	/**
	 * *********************************************************************<br>
	 ...
	 * @deprecated use the safer methods {@link #clLogStreamListGet(long, java.nio.IntBuffer, clUtils.ClLogStreamInfoT.ByReference[])} and {@link #clLogStreamListGet(long, com.sun.jna.ptr.IntByReference, clUtils.ClLogStreamInfoT.ByReference[])} instead
	 */
	@Deprecated 
	 ...
	 */
	int clLogStreamListGet(long hLog, IntBuffer pNumStreams, clUtils.ClLogStreamInfoT.ByReference ppLogStreams[]);
	/**
	 * ***********************************<br>
	 *  \brief Gets the list of active streams available in the cluster.<br>
	 *  \par Header File:<br>
	 ...
	 * <i>native declaration : /home/clovis/opt/sdk-6.1/src/SAFplus/components/log/include/clLogApi.h:1679</i>
	 */
	int clLogStreamListGet(long hLog, IntByReference pNumStreams, clUtils.ClLogStreamInfoT.ByReference ppLogStreams[]);
	/**
	 ...
	 */
	int clLogWriteDeferred(long handle, int severity, short servicId, short msgId, ByteBuffer pFmtStr, Object... varArgs1);
	/**
	 ...
	 */
	int clLogWriteDeferredForce(long handle, int severity, short servicId, short msgId, ByteBuffer pFmtStr, Object... varArgs1);
	/**
	...
	//int clLogMsgWrite(long streamHdl, int severity, short serviceId, ByteBuffer pArea, ByteBuffer pContext, ByteBuffer pFileName, int lineNum, ByteBuffer pFmtStr, Object... varArgs1);
	/**
	 ...
	 */
	int clLogMsgWriteDeferred(long streamHdl, int severity, short serviceId, ByteBuffer pArea, ByteBuffer pContext, ByteBuffer pFileName, int lineNum, ByteBuffer pFmtStr, Object... varArgs1);
	/**
	 ...
	 */
	int clLogMsgWriteConsole(long streamHdl, int severity, short serviceId, ByteBuffer pArea, ByteBuffer pContext, ByteBuffer pFileName, int lineNum, ByteBuffer pFmtStr, Object... varArgs1);
	/**
	 ...
	 */
	int clLogFormatRecordHeader(ByteBuffer msgHeader, int maxHeaderLen, ByteBuffer msg, short consoleFlag, int msgIdCnt, int severity, ByteBuffer pFileName, int lineNum, ByteBuffer pArea, ByteBuffer pContext);
	/**
	 ...
	 */
	int clLogFormatRecord(ByteBuffer msgHeader, int maxHeaderLen, ByteBuffer msg, int maxMsgLen, short consoleFlag, int msgIdCnt, int severity, ByteBuffer pFileName, int lineNum, ByteBuffer pArea, ByteBuffer pContext, ByteBuffer pFmtStr, Object... varArgs1);
	/**
	 ...
	 * @deprecated use the safer methods {@link #clLogSeverityFilterToValueGet(short, java.nio.IntBuffer)} and {@link #clLogSeverityFilterToValueGet(short, com.sun.jna.ptr.IntByReference)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #clLogSeverityValueToFilterGet(int, java.nio.ShortBuffer)} and {@link #clLogSeverityValueToFilterGet(int, com.sun.jna.ptr.ShortByReference)} instead
	 */
	@Deprecated 
	 ...
	 */
	int clLogStreamFilterSet(Pointer pStreamName, int streamScope, Pointer pStreamScopeNode, byte filterFlags, ClLogFilterT.ByValue filter);
	/**
	 ...
	 */
	int clLogStreamFilterGet(Pointer pStreamName, int streamScope, Pointer pStreamScopeNode, ClLogFilterT pFilter);
	/**
	 ...
	 */
	int clLogSeverityGet(ByteBuffer pSevName);
	/**
	 ...
	 */
	int clLogTimeGet(ByteBuffer pStrTime, int maxBytes);
